  ...
  const logout= async () => {
    ...
    >
      <path d="M4 4v2h16V4M4 7l-1 5v2h1v6h9c-.05-.34-.08-.69-.08-1.05 0-1.22.38-2.42 1.08-3.42V14h1.54c1-.67 2.17-1.04 3.37-1.04.71 0 1.42.13 2.09.38V12l-1-5M6 14h6v4H6m12-3v3h-3v2h3v3h2v-3h3v-2h-3v-3" />
                                   ...
                                   <NavLink to='/createproduct'> <span className="text-gray-100">Add Product</span></NavLink>
                                </div>
                            </li>
                            <li className="rounded-sm">
                                <div
    ...
    >
      <path d="M22 3H2c-1.09.04-1.96.91-2 2v14c.04 1.09.91 1.96 2 2h20c1.09-.04 1.96-.91 2-2V5a2.074 2.074 0 00-2-2m0 16H2V5h20v14m-8-2v-1.25c0-1.66-3.34-2.5-5-2.5-1.66 0-5 .84-5 2.5V17h10M9 7a2.5 2.5 0 00-2.5 2.5A2.5 2.5 0 009 12a2.5 2.5 0 002.5-2.5A2.5 2.5 0 009 7m5 0v1h6V7h-6m0 2v1h6V9h-6m0 2v1h4v-1h-4" />
                                    ...
                                    <NavLink to='/productdetails'><span className="text-gray-100">My Product</span></NavLink>  
                                </div>
                            </li>
                            <li className="rounded-sm">
                                <div
                            ...
                            <li className="rounded-sm">
                                ...
                                >
                                  ...
                                  <NavLink to='/login'><span className="text-gray-100" onClick={logout}>Logout</span></NavLink>  
                                </a>
                            </li>
                        </ul>
                    </div>
